...
public class MentorshipController {
    ...
    public ResponseEntity<?> getMentorMatches(@PathVariable String mentorId) {
        try {
            ...
            response.put("activeMatches", matches.stream().filter(m -> m.getStatus() == MentorshipMatchStatus.ACTIVE).count());
    ...
    public ResponseEntity<?> recordSession(@RequestBody RecordSessionRequest request) {
        try {
            ...
            response.put("totalSessions", updatedMatch.getSessionCount());
